            ...
            if naive_flag==False and oracle_flag==False:
                ...
                if perb_rate<0.5:
                    ...
                    if flag==False:
                        ...
                        continue
                    green_inversor.save_solution(save_path, output_file_name)#'1-'+
